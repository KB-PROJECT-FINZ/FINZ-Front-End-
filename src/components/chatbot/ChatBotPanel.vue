...
<<<<<<< HEAD
    ...
    >
      ...
      >
        <!-- 헤더 -->
        <div class="flex items-center justify-between bg-gradient-to-r from-blue-400/90 to-purple-500/90 backdrop-blur-sm px-6 py-4">
          <div class="flex items-center space-x-3">
            <div class="w-8 h-8 bg-white/30 rounded-2xl flex items-center justify-center backdrop-blur-sm">
...
=======
      <div v-if="isOpen" class="fixed inset-0 z-50 flex items-end" @click="closeChat">
        <!-- 배경 오버레이 -->
        <div class="absolute inset-0 bg-black/20 backdrop-blur-sm"></div>
>>>>>>> f8bfeb56b71413417c2195a37d8c70ae807624ba
